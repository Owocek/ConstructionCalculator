...
<div id='container'>
    ...
    <form:form method="post" modelAttribute="allFactors">
     ...
     Tabela 4.4N, 4.5N">
        ...
        <div><form:radiobuttons path="exposureClass" items="${listOfExposureClass}"></form:radiobuttons></div>
     ...
     Tabela 2.1">
        ...
        <div><form:radiobuttons path="structuralClass" items="${listOfStructuralClass}"></form:radiobuttons></div>
